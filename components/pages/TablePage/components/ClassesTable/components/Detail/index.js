...
export default function Detail({ showDetail, setShowDetail, setDetail, detail, state }) {
    ...
    const [suggestionOpened, { open: suggestionOpen, close: suggestionClose }] = useDisclosure(false);
    ...
    const openSuggestionModal = useCallback(_ => {
        suggestionOpen();
    }, [suggestionOpen]);

    const closeSuggestionModal = useCallback(_ => {
        suggestionClose();
    }, [suggestionClose]);
        ...
        <>
            ...
            <Modal
                title={
                    <div className={styles.title}>
                        ...
                        <div
                            ...
                            tabIndex={0}
                            onKeyUp={(event) => {
                                if (event.key === " " || event.key === "Enter") openSuggestionModal();
                            }}
                ...
                className={join(
                    ...
                    suggestionOpened ? styles.hideDetail : styles.showDetail
                )}
                styles={{
                        ...
                        <div className={styles.form}>
                            {message.meet === "none" ? <>
                                ...
                                >
                                    ...
                                    >
                                        {copySuccess0 ? <>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" strokeWidth="2" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
